    ...
    return (
        <div className="p-2 md:p-0">
            <Card className=" w-full sm:max-w-md">
                ...
                <div className="flex justify-between flex-col md:flex-row gap-3 px-6 py-2 text-center text-sm">
                    <p className="text-gray-600">
                        Don't have an account,{' '}
                        <Link href="/register" className="text-emerald-600 text-nowrap font-semibold hover:underline">
                            Register
                        </Link>
                    </p>
                    <Link href={"/forgot-password"} className="text-blue-600 text-nowrap font-semibold hover:underline">
                        forget password?
                    </Link>
                </div>
            </Card>
